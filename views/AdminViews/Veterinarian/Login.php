  ...
  <div class="main_area_login">
      ...
      <div class="login_area_pic">
        <div class="image_login">
            <img src="login.png">
            <p>Caring for Animals isn't What I do. It's Who I am.</p>
        </div>
          
      </div>
      <div class="login_area_text">
        <h1>Veterinarian Login</h1>
            <form method="POST" action="../../../controllers/adminControllers/VeterinarianControllers/VetLoginCheck.php" class="login_table">
              <table align="center">
                <tr>
