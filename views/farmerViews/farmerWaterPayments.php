...
<body>
    ...
    <div class="daynamic_area">
        <h2 class="daynamic_area_heading_text">Water Payment</h2><hr>
            ...
            <form method="POST">
                        <table align="center" style="font-size:20px;" class="create_user">
                            ...
                            <tr >
                                <td >
                                     <br><input type="button" class="submit_button" onclick="waterpayinsert()" value="Pay">
                                </td>
                            </tr>
                        </table>
            </form>
    ...
    <script>
        function waterpayinsert(){
            ...
            http.open('POST', '../../controllers/farmerControllers/waterPaymentCheck.php', true);
