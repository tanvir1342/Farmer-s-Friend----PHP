...
<head>
    ...
    <title>Machinaries Guidelines Text</title>
...
<body>
    ...
    <div class="daynamic_area">
        <h2 class="daynamic_area_heading_text">Machinaries Guidelines Text</h2><hr>
...
<table width = 100%;>
  ...
  <tr  height = 700px>
		...
		<td valign="top">
			<h1 align="center">Machineries Guidelines (Text)</h1><hr>

			<label for="guidelines">Machineries Guidelines or Uses:</label><br><br>
