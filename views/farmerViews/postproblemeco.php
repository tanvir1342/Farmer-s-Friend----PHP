...
<head>
    ...
    <title>Post Costing Related Problems</title>
...
<body>
    ...
    <div class="daynamic_area">
        <h2 class="daynamic_area_heading_text">Post Costing Related Problems</h2><hr>
               <table align="center" style="font-size:20px;" class="create_user">
                <form method="POST">
                    ...
                    <tr>
                        <td></td>
                        <td><input  type="button" class="submit_button" onclick="ecoprobinsert()" value="submit"></td>
                    </tr>
                </form>
    ...
    <script>
        function ecoprobinsert(){
            ...
            http.open('POST', '../../controllers/farmerControllers/postProblemCheckeco.php', true);
...
<table width = 100%;>
  ...
  <tr  height = 700px>
        ...
        <td valign="top">
            <h1 align="center"> Post Costing Related Problems </h1> <hr>
            <table  align="center">
